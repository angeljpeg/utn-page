...
export default function Header({ title, component }: HeaderProps) {
  return (
    <div className="px-6 w-screen py-8 mx-auto text-center text-white shadow-xl sm:rounded-lg sm:w-[75vw] min-w-fit animate-animated-gradient bg-gradient-to-br from-lime-500 to-green-500 bg-[length:300%_300%]">
      {title ? (
