...
const CertificacionesPage = React.lazy(() => import("@pages/Certificaciones/Certificaciones"))
const EducacionContinuaPage = React.lazy(() => import("@pages/EducacionContinua/EducacionContinua"))
...
const CuadriculaLinks = React.lazy(() => import("@components/CuadriculaLinks/CuadriculaLinks"))
...
export const AppRouter = () => {
  return (
    <Routes>
      ...
      <Route path="/certificaciones" element={<GeneralLayout componenteHeader={<p>CERTIFICACIONES</p>} url="https://blog.orange.es/wp-content/uploads/sites/4/2024/03/fondos-de-pantalla-3d-paisaje.jpg" isHome={false}/>}>
        <Route index element={<CertificacionesPage />}/>
        <Route path="*" element={<NotFoundPage />} />
      </Route>
      <Route path="/educacion-continua" element={<GeneralLayout componenteHeader={<p>ECST</p>} url="https://blog.orange.es/wp-content/uploads/sites/4/2024/03/fondos-de-pantalla-3d-paisaje.jpg" isHome={false}/>}>
